    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content" class="col-md-12">
                ...
                $sql = "INSERT INTO employees(name,description,email,joined,gender,phone,tmp,employee_id,address)VALUES('$name','$description','$email','$joined','$gender','$phone','$tmp','$employee_id','$address')";
