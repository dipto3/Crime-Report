    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content" class="col-md-12">
                ...
                <div class="col-lg-4 col-md-6 ">
                    <div class="panel panel sammac sammacmedia">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-4">
                                    <a href="v_users.php"><i class="fa fa-user fa-4x"></i></a>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 g-danger">
                    <div class="panel panel strover sammacmedia">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-4">
                                <a href="v_issue.php"><i class="fa fa-link fa-4x"></i></a>
                                </div>
                                <div class="col-xs-8 text-right">
                                    <div class="huge"><?php echo $cases;?></div>
                                    <div>Total Number Of Cases</a></div>
                                </div>
                            </div>
                        </div>
