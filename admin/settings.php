        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                if(isset($mysqli,$_POST['update'])){
                    ...
                    $surname = mysqli_real_escape_string($mysqli,$_POST['description']);
                    $phone = mysqli_real_escape_string($mysqli,$_POST['phone']);
                    $email = mysqli_real_escape_string($mysqli,$_POST['email']);
                    
                    $sqlTaru = "UPDATE users SET name ='$name', desription ='$desription', phone ='$phone', email ='$email' WHERE username= '{$_SESSION['username']}'";
        ...
        <div class="row form-group">
          <div class="col-lg-6">
            ...
            <label>Desription</label>
              <input type="text" class="form-control" name="desription"  value="<?php echo $eprow['description'];?>" required>
            </div>  
        </div>
            <div class="row form-group">
          <div class="col-lg-6">
