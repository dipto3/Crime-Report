    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content" class="col-md-12">
                ...
                $sql = "INSERT INTO users(name,description,username,email,joined,type,permission,gender,phone,password)VALUES('$name','$description','$username','$email','$joined','user','$permission','$gender','$phone','$password')";
